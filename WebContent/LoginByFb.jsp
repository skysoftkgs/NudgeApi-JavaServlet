...
<form role="form" method="post" action="LoginByFb">

               
					
						<div class="form-group">
						<label for="exampleInputEmail1">fb_id<font color="red">*</font></label> <input type="text"
							class="form-control" id="fb_id" name="fb_id"
