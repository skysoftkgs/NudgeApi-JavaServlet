...
/**
 * Servlet implementation class EditProfileManual
 */
@WebServlet("/UpdateProfileManual")
public class UpdateProfileManual extends HttpServlet {
		...
		try {
			...
			for(FileItem item: multiparts)
			{
					...
					if(item.getFieldName().equals("user_id"))
				{
					...
					else if(item.getFieldName().equals("friend_id"))
					{
						friend_id=item.getString();
					}
			...
			if(user_id.length()!=0 && friend_id.length()!=0 && name.length()!=0 && relationship.length()!=0 && gender.length()!=0 && last_name.length()!=0)
			{
				...
				obj_bean.setFriend_id(friend_id);
			...
			//	obj_bean.setDob(dob);
				...
				boolean add_response=obj_model.UpdateProfileManual(con, obj_bean);
				...
				if(add_response)
				{
					...
					boolean check_resp=obj_model.CheckDobAsEvent(con,user_id,friend_id);
					
					if(check_resp)
					{
						boolean nudge_response = obj_model.UpdateDobAsEvent(con, user_id,friend_id,event,timestampToDate,dob,nudge_timestamp,nudgeDateTimestampToDate);

					}
					else
					{	
					boolean nudge_response = obj_model.AddDobAsEventInEdit(con, user_id,friend_id,event,timestampToDate,dob,nudge_timestamp,nudgeDateTimestampToDate);
					}
				*/
					
					if(relationship.equalsIgnoreCase("1") || relationship.equalsIgnoreCase("12") || relationship.equalsIgnoreCase("15") || relationship.equalsIgnoreCase("16"))
					{
					...
					//	String a=obj_model.convertToYYMMDD(con, currentdate);
						...
						if(day == 1)
						{
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate1,updatedatetimestamp,relationship,event_fathersday,notify);
						
							if(event_response)
							{
							JSONObject event=obj_model.GetEventDetails(con,user_id,friend_id,event_fathersday);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate2,updatedatetimestamp,relationship,event_fathersday,notify);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate3,updatedatetimestamp,relationship,event_fathersday,notify);
/*
							if(event_response)
							{
								JSONObject eveobj= new JSONObject();
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate4,updatedatetimestamp,relationship,event_fathersday,notify);
					...
					//		String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate5,updatedatetimestamp,relationship,event_fathersday,notify);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate6,updatedatetimestamp,relationship,event_fathersday,notify);
						...
						if(day == 7)
						{
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate7,updatedatetimestamp,relationship,event_fathersday,notify);
...
*/
					...
					if(relationship.equalsIgnoreCase("2") || relationship.equalsIgnoreCase("11")|| relationship.equalsIgnoreCase("15") || relationship.equalsIgnoreCase("16"))
					{ 
						//mothersday
					...
					//	String currentdate=Util.MillisecondToDateNewFathersDay(String.valueOf(currenttimestamp));
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate1,updatedatetimestamp,relationship,event_mothersday,notify);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate2,updatedatetimestamp,relationship,event_mothersday,notify);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate3,updatedatetimestamp,relationship,event_mothersday,notify);
						...
						if(day == 4)
						{
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate4,updatedatetimestamp,relationship,event_mothersday,notify);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate5,updatedatetimestamp,relationship,event_mothersday,notify);
						...
						if(day == 6)
						{
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate6,updatedatetimestamp,relationship,event_mothersday,notify);
						...
						if(day == 7)
						{
							...
							boolean event_response = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate7,updatedatetimestamp,relationship,event_mothersday,notify);
...
*/
					...
					if(relationship.equalsIgnoreCase("3") || relationship.equalsIgnoreCase("4") || relationship.equalsIgnoreCase("6") || relationship.equalsIgnoreCase("7") || relationship.equalsIgnoreCase("8") || relationship.equalsIgnoreCase("9") || relationship.equalsIgnoreCase("10") || relationship.equalsIgnoreCase("19") || relationship.equalsIgnoreCase("15") || relationship.equalsIgnoreCase("16"))
					{
						//long mothersdate=Util.getSecondSundayOfMay();
						//System.out.println("fathersdate=="+mothersdate);
						...
						boolean event_response = obj_model.UpdateRelationAsEvent(con, user_id,friend_id,timestampToDate_M,halloween,nudge_timestamp_M,nudgeDateTimestampToDate_M,relationship,event_halloween,notify);
						...
						// To convert timestamp to date
						String nudgeDateTimestampToDate_B= Util.MillisecondToDateNew(String.valueOf(nudge_timestamp_B));
                        System.out.println("nudgeDateTimestampToDate_B=="+nudgeDateTimestampToDate_B);
                        
						boolean event_response1 = obj_model.UpdateRelationAsEvent(con, user_id,friend_id,timestampToDate_B,christmas,nudge_timestamp_B,nudgeDateTimestampToDate_B,relationship,event_christmas,notify);
					...
					//	String currentdate=Util.MillisecondToDateNewFathersDay(String.valueOf(currenttimestamp));
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response1 = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate,updatedatetimestamp,relationship,event_friendshipday,notify);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response1 = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate2,updatedatetimestamp,relationship,event_friendshipday,notify);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response1 = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate3,updatedatetimestamp,relationship,event_friendshipday,notify);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response1 = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate4,updatedatetimestamp,relationship,event_friendshipday,notify);
					...
					//		String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response1 = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate5,updatedatetimestamp,relationship,event_friendshipday,notify);
						...
						//	String timestampToDate_F= Util.MillisecondToDateNewFathersDay(updatedatetimestamp);
							...
							boolean event_response1 = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate6,updatedatetimestamp,relationship,event_friendshipday,notify);
						...
						if(day == 7)
						{
							...
							boolean event_response1 = obj_model.UpdateRelationAsEventNew(con, user_id,friend_id,updateddate7,updatedatetimestamp,relationship,event_friendshipday,notify);
...
*/
					...
					if(relationship.equalsIgnoreCase("13") || relationship.equalsIgnoreCase("14") )
					{
						...
						boolean event_response1 = obj_model.UpdateRelationAsEvent(con, user_id,friend_id,timestampToDate_Chris,christmas,nudge_timestamp_Chris,nudgeDateTimestampToDate_Chris,relationship,event_christmas,notify);
					...
					if(relationship.equalsIgnoreCase("17") || relationship.equalsIgnoreCase("18") )
					{
						//valentines
						String notify="1";
						String event_valentines="8";
                        long valentines=1514187528;
						...
						boolean event_response = obj_model.UpdateRelationAsEvent(con, user_id,friend_id,timestampToDate_Val,valentines,nudge_timestamp_Val,nudgeDateTimestampToDate_Val,relationship,event_valentines,notify);
						...
						boolean event_response1 = obj_model.UpdateRelationAsEvent(con, user_id,friend_id,timestampToDate_Ann,anniversary,nudge_timestamp_Ann,nudgeDateTimestampToDate_Ann,relationship,event_anniversary,notify1);
					...
					UploadProfileModel obj_model1=new UploadProfileModel();
					events=obj_model1.getEvents(con,user_id,friend_id);
					
					userobj.put("event", events);
					
					printOutput(Constant.StatusSuccess, Constant.MessageUpdate,userobj,upcoming_nudges);
				}
				else
				{
					printOutput(Constant.StatusFail, Constant.MessageNOTUPDATE,userobj,upcoming_nudges);
				}
		}
			else
			{
			printOutput(Constant.StatusFail, Constant.INVALID_INPUTS,userobj,upcoming_nudges);
			}
		} 
		catch (Exception e) {
			// TODO: handle exception
			e.printStackTrace();
			printOutput(Constant.StatusFail, Constant.FAIL_RESPONSE,userobj,upcoming_nudges);
		}
		finally
		{
			Config.DB_colse();
	...
	public void printOutput(String status,String message,JSONObject userobj,JSONArray upcoming_nudges)
	{
		try {
